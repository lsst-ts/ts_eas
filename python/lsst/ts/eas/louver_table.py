...
# TODO: OSW-2359 Remove this module once the louver table is available in the
# ts_xml conda package. This is a temporary copy of
# lsst.ts.xml.tables.mtdome.louver_table, used as a backward compatibility
# until the table ships in the ts-xml conda package. Keep it in sync with the
# ts_xml source.
