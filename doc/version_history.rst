...
- Added a temporary copy of the MTDome louver table, for backward compatibility until it is available in the ts_xml conda package. (`OSW-2358 <https://rubinobs.atlassian.net/browse/OSW-2358>`_)
